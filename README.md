...
3. From inside the machine run the file [download_workshop_images.sh](https://github.com/sighupio/workshop-advanced-kubernetes/blob/master/kubernetes/download_workshop_images.sh)
